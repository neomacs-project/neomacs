...
(defun backward-delete-until (marker predicate)
  (with-marker (beg marker)
    (setf (pos beg) (or (npos-prev-until beg predicate)
...
(defun forward-delete-until (marker predicate)
  (with-marker (end marker)
    (setf (pos end) (or (npos-next-until end predicate)
